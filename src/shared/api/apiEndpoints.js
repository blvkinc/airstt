...
export const publicApi = Object.freeze({
  events: Object.freeze({
    ...
    filterSchema: () => buildPublicPath('events', 'filter-schema'),
    detail: (eventId) => buildPublicPath('events', eventId),
    conceptOptions: (eventId) => buildPublicPath('events', eventId, 'concept-options'),
  ...
  eventConcepts: Object.freeze({
    detail: (conceptId) => buildPublicPath('event-concepts', conceptId),
  }),
  venues: Object.freeze({
    list: () => publicRouteFamilies.venues,
    filterSchema: () => buildPublicPath('venues', 'filter-schema'),
...
export const customerApi = Object.freeze({
  ...
  cancellationRequests: Object.freeze({
